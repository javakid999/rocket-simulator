...
class Game:
    ...
    def init_world(self):
        ...
        self.world.add_planet([700,637300], 637000, {'land': planet_texture, 'water': water_texture, 'leaf': [self.assetManager.assets['leaf1'], self.assetManager.assets['leaf2']], 'rock': [self.assetManager.assets['rock1'], self.assetManager.assets['rock2'], self.assetManager.assets['rock3'], self.assetManager.assets['rock4']]}, 5.97*10**21, 0.08, (128,128,255), True)
        ...
        self.world.add_planet([700,4636040], 173740, {'land': moon_texture, 'water': moon_water_texture, 'leaf': -1, 'rock': [self.assetManager.assets['rock1'], self.assetManager.assets['rock2'], self.assetManager.assets['rock3'], self.assetManager.assets['rock4']]}, 7.348*10**19, 0.08, (200,200,200), False, [1000,0])
