...
class Game:
    ...
    def init_world(self):
        ...
        self.world.add_planet([700,637300], 637000, {'land': planet_texture, 'water': water_texture, 'leaf': self.assetManager.assets['leaf']}, 5.97*10**21, 0.08, (128,128,255), True)
        ...
        self.world.add_planet([700,4636040], 173740, {'land': moon_texture, 'water': moon_water_texture, 'leaf': self.assetManager.assets['leaf']}, 7.348*10**19, 0.08, (200,200,200), False, [1000,0])
